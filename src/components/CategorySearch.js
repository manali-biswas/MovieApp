    ...
    render() {
        ...
        return (
            <div className="container mt-5">
                ...
                <div className="mt-5">
                    <SearchResults modal={ this.props.modal } details={this.props.details} detailloading={this.props.detailloading} detailerr={this.props.detailerr} ModalToggle={this.props.ModalToggle} onModalClick={this.props.onModalClick} results={this.props.results} loading={this.props.loading} err={this.props.err} choice={ this.props.choice }/>
                </div>
            </div>
        )
    }
